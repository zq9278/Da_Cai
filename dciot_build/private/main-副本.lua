...
function on_timer(timer_id)
        ...
        if timer_id == 1 then                             --定时器1超时自动
                ...
                set_value(12, 5, count)
                set_value(12, 6, result)
                --当计时器定时为0时界面跳转+结束信号
...
function on_control_notify(screen, control, value)
        ...
        if screen == 6 then
                if control == 3 and value == 0 then --控件‘减’弹起
                        ...
                        set_value(6, 5, value)       --设置数值
                        set_value(6, 6, value_force) --设置数值
                end
        ...
        if screen == 10 then                         --第二页图标
                if control == 3 and value == 0 then  --控件‘减’弹起
                        ...
                        set_value(10, 5, value)     --设置数值
                        set_value(10, 6, value_hot) --设置数值
                end
        ...
        if screen == 11 then                        --第二页图标
                if control == 3 and value == 0 then --控件‘减’弹起
                        ...
                        set_value(11, 5, value)       --设置数值
                        set_value(11, 6, value_force) --设置数值
                end
